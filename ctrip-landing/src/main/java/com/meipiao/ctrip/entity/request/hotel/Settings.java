    ...
    private List<String> ExtendedNodes = new ArrayList<String>(){
        {
            ...
            //"HotelStaticInfo.Policies",//酒店政策：入住和离店时间、儿童政策、早餐信息、宠物
            //"HotelStaticInfo.AcceptedCreditCards",//酒店前台可用支付方式
            //"HotelStaticInfo.ImportantNotices",//酒店重要通知
            //"HotelStaticInfo.FacilitiesV2",//酒店设施设备：设施设备ID、设施设备状态、设施设备类型、收费信息（收费还是免费，收费明细）、位置信息（住宿内还是住宿外）、营业时间、餐厅信息、子设施信息、年龄限制（最大年龄，最小年龄）
            //"HotelStaticInfo.Pictures",//酒店图片：图片类型、分类描述、图片链接
            //"HotelStaticInfo.Descriptions",//	酒店描述：描述类型（1短描述2长描述,3已废弃）、描述文本
            this.add("HotelStaticInfo.ContactInfo");//酒店联系信息：酒店联系电话、酒店传真
            //"HotelStaticInfo.HotelTags.IsBookable",//IsBookable：是否可订
